  ...
  <div id="content">
    <div class="row">
      <div class="col-sm-9">
        ...
        <div class="row">
          <div class="col-sm-4">
            <img src="/source/image/product/{{$sanpham->image}}" alt="" width="200px" height="200px">
          </div>
          <div class="col-sm-8">
        ...
        <div class="woocommerce-tabs">
          ...
          <div class="panel" id="tab-comment">
                  ...
                  <div class="card-body">
                    <form method="post" action="/comment/{{$sanpham->id}}">
                      ...
                      <div class="form-group">
                        <textarea class="form-control" name="comment" required style="width: 760px;"></textarea>
                      </div>
                      <button type="submit" class="beta-btn primary" style="margin-bottom: 20px;">Bình luận</button>
                    </form>
                  </div>
                </div>
              </div>
            ...
            <p style="margin-left: 18px">
              ...
              <p style="margin-left: 18px;">{{$comment->comment}}</p>
            </p>
            @endforeach
            @else
            ...
            <div class="col-sm-4">
              <div class="single-item">
                <div class="single-item-header">
                  <a href="detail/{{$sp->id}}"><img src="/source/image/product/{{$sp->image}}" alt="" width="280px" height="200px"></a>
                </div>
      ...
      <div class="col-sm-3 aside">
            ...
            <div class="beta-sales beta-lists">
                @foreach ($bestseller as $best )
                    <div class="media beta-sales-item">
                        <a class="pull-left" href="detail/{{$best->id}}"><img src="/source/image/product/{{$best->image}}"
                            alt="" ></a>
                        <div class="media-body">
                        <div class="name">{{$best->name}}</div>
                        <span class="beta-sales-price">{{number_format($best->unit_price)}} đ</span>
                        </div>
                    </div>
                @endforeach
            </div>
        ...
        <div class="widget">
          ...
          <div class="widget-body">
            <div class="beta-sales beta-lists">
                @foreach ($newproducts as $pr )
                    <div class="media beta-sales-item">
                        <a class="pull-left" href="detail/{{$pr->id}}"><img src="/source/image/product/{{$pr->image}}"
                            alt=""></a>
                        <div class="media-body">
                        <div class="name">{{$pr->name}}</div>
                        <span class="beta-sales-price">{{number_format($pr->unit_price)}} đ</span>
                        </div>
                    </div>
                @endforeach
            </div>
